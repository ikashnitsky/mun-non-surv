...
ggsave(filename = "figures/life-exp-sex-gap.pdf", gg_diag_le_sex, 
       width = 7, height = 4)
...
ggsave("figures/maps-life-expectancy-sex.pdf", map_le_sex, 
       width = 12, height = 6)
...
ggsave("figures/maps-q5065-sex.pdf", map_q5065_period_sex, 
       width = 10, height = 8.5)
...
ggsave(filename = "figures/life-exp-step-cum.pdf", gg_step_cum, 
       width = 7, height = 4)
